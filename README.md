...
Prerequisites: Go 1.25+, Node 22, and the
[Wails v3 prerequisites](https://v3.wails.io/getting-started/installation)
for your platform.
...
The desktop shell targets Wails v3 (module `github.com/wailsapp/wails/v3`,
CLI `wails3`). `.app` bundling, dev-mode taskfiles and the Linux/Windows
packaging matrix are being re-added as the v3 migration lands.
