...
// implements the interactive interact.Backend for user questions. It
...
// Ask implements interact.Backend: it registers the prompt for the
// frontend and blocks until an answer arrives or ctx ends.
func (b *Bridge) Ask(ctx context.Context, spec interact.Spec) (interact.Reply, error) {
...
// Resolve implements interact.Resolver: it notifies the frontend that a
