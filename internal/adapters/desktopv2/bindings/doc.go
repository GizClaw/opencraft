// Package bindings adapts desktopv2 core services for the Wails UI
// shell. It holds no domain state: every binding is a thin DTO
// adapter over core.Core services, and domain logic lives in
// orchestration/host or the capabilities below it.
//
